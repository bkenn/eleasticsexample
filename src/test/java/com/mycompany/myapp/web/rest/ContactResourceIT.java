...
class ContactResourceIT {
     ...
     *
     * @see com.mycompany.myapp.repository.search.ContactSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().value(DEFAULT_VALUE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().value(UPDATED_VALUE);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.value(UPDATED_VALUE);
    ...
    void searchContact() throws Exception {
        ...
        // Initialize the database
        contactRepository.saveAndFlush(contact);
        when(mockContactSearchRepository.search("id:" + contact.getId())).thenReturn(Stream.of(contact));
